...
const DeliveryDetails = () => {
    ...
    const [showStatus, setShowStatus] = useState(2);
                ...
                {showProduct.map((deliveredProducts, key) => (
                    ...
                    <div className='imgdescDiv'>
                        <div className='prdctImdDiv'>
                            <img src={deliveredProducts.prdctimgsrc} alt='img' className='prdctImdDiv' />
                        </div>

                        <div className='ImgDescDiv'>
                            <div>
                                <div style={{ fontSize: "14px" }}>{deliveredProducts.ProductDescription}</div>
                                <div style={{ display: "flex", }}>
                                    <div style={{ marginTop: "35px", marginRight: "5px", fontSize: "16px" }}>{deliveredProducts.productRate}</div>
